...
describe OrdersController do
  ...
  let(:valid_attributes) { { "product" => "MyString" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved order as @order" do
        ...
        post :create, {:order => { "product" => "invalid value" }}, valid_session
        assigns(:order).should be_a_new(Order)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested order" do
        ...
        Order.any_instance.should_receive(:update_attributes).with({ "product" => "MyString" })
        put :update, {:id => order.to_param, :order => { "product" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the order as @order" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Order.any_instance.stub(:save).and_return(false)
        put :update, {:id => order.to_param, :order => { "product" => "invalid value" }}, valid_session
        assigns(:order).should eq(order)
      end
